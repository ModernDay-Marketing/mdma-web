...
Founder images live in `public/images/founder`. The current primary portrait for About and the founder page is `public/portraits/dharma-teja-window-light.jpg`, a web sized copy of Dharma’s supplied `T2011580.JPG` (15 September 2026). Preserve its natural colour and window light; keep the face clear when cropping responsively.
...
The Design and Social Media pricing sections follow the Websites section’s two column layout: introduction and linked case preview on the left, fees and scope on the right. On mobile, stack the preview and scope. Social Media retains its acid background and explains the focused ₹80,000 engagement and increasing scope towards ₹3,00,000.
